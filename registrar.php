...
#Validacion para el LAPSO 2018-E limita a 3 asignaturas
/*if($todas_mat > 3){// Intenta inscribir mas asignaturas de lo permitido.
	#echo "SOLO PUEDE INSCRIBIR tres ASIGNATURAS <BR>";
	#die();
	$formOK=false;
	echo '<script languaje=\"javacript\">alert("Lo siento, estas intentando inscribir mas asignaturas de lo permitido.\n\nEl maximo permitido para este lapso es tres(3) asignaturas, por favor ingrese nuevamente al sistema y asegurese de seleccionar correctamente sus asignaturas.");window.close();</script>';
}*/
