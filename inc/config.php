...
$raizDelSitio		= 'http://'.$_SERVER['SERVER_NAME'].'/web/urace/pregrado/estudiantes/agc_r/';
$urlDelSitio		= 'http://'.$_SERVER['SERVER_NAME'].'/web/urace';

$lapsoProceso		= '2018-2';
$tLapso				= ' Lapso '.$lapsoProceso;
/*cambie el nombre-para cuando se genere el log y se hagan las pruebas*/
$laBitacora			= $_SERVER[DOCUMENT_ROOT].'/log/pregrado/estudiantes/agregados/solo-cola_'.$lapsoProceso.'.log';
...
if ($modoInscripcion == '1'){
	...
	$tProceso	= 'Inclusi&oacute;n de Asignaturas en Cola';
}
...
$mensajeppal = "Disculpe, el proceso ha finalizado.";
